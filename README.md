...
```
npm create cloudflare@latest -- --template=cloudflare/templates/proud-frog-222a
```

A live public deployment of this template is available at [https://proud-frog-222a.templates.workers.dev](https://proud-frog-222a.templates.workers.dev)
